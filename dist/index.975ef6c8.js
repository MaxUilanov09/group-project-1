...
(()=>{
    ...
    function swapReview1() {
        if (!refs.reviewWrap1.classList.contains("reviews__swap1")) toggleSwap(1);
        if (refs.reviewWrap1.classList.contains("reviews__swap2")) toggleSwap(2);
        if (refs.reviewWrap1.classList.contains("reviews__swap3")) toggleSwap(3);
    }
